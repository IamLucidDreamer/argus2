      ...
      <div className="w-full">
        ...
        <div className="bg-white shadow-button-shadow-2 max-w-1366 mx-3 2xl:mx-auto my-6 rounded-2xl">
          <nav className="flex flex-col md:flex-row text-gray-3 text-lg items-center">
            <button onClick={() =>setShow(1)} className={`w-full md:w-1/2 py-4 rounded-2xl font-bold md:-mt-8 bg-white hover:shadow-none ${show ===1 ? 'shadow-none' : "shadow-button-shadow-2"}`}>Current Instructor</button>
            <button onClick={() =>setShow(2)} className={`w-full md:w-1/2 py-4 rounded-2xl font-bold md:-mt-8 bg-white hover:shadow-none ${show ===2 ? 'shadow-none' : "shadow-button-shadow-2"}`}>Add New Instructor</button>
          </nav>
          <div className="p-4">
