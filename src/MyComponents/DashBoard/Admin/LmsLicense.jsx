      ...
      <div className="w-9/12 sm:w-10/12">
        ...
        <div className="bg-white shadow-button-shadow-2 max-w-1366 mx-3 2xl:mx-auto mt-72 md:mt-0 mb-10 md:my-16 rounded-2xl">
          <nav className="flex flex-col md:flex-row text-gray-3 text-lg items-center">
            <button onClick={() =>setShow(1)} className={`w-full md:w-1/4 py-4 rounded-2xl font-bold -mt-64 md:-mt-8 bg-white hover:shadow-button-shadow-3 ${show ===1 ? 'shadow-none' : "shadow-button-shadow-2"}`}>Documents</button>
            <button onClick={() =>setShow(2)} className={`w-full md:w-1/4 py-4 rounded-2xl font-bold mt-4 md:-mt-8 lg:mr-1 lg:ml-2 bg-white hover:shadow-button-shadow-3 ${show ===2 ? 'shadow-none' : "shadow-button-shadow-2"}`}>Baskets</button>
            ...
            <button onClick={() =>setShow(4)} className={`w-full md:w-1/4 py-4 rounded-2xl font-bold mt-4 md:-mt-8 bg-white hover:shadow-button-shadow-3 ${show ===4 ? 'shadow-none' : "shadow-button-shadow-2"}`}>Training No.</button>
          </nav>
          <div className="p-4">
