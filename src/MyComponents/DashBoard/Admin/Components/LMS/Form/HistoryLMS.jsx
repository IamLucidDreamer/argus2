  ...
  return (
    <div>
      <div className="flex flex-row justify-between">
        <button className="ml-auto px-4 py-2 bg-red-1 text-white font-bold rounded-2xl m-3 hover:text-red-1 hover:bg-white border-2 border-red-1">
          Filter
        </button>
      </div>
      ...
      <div className="flex flex-col lg:flex-row text-lg mb-2 rounded-xl border-2 lg:border-none border-red-1">
        ...
        <h1 className="lg:w-7/12 px-3 py-3 text-gray-2 rounded-xl border-2  mx-1 my-1 lg:my-0">
          ...
          at natus aut delectus, eveniet culpa illo necessitatibus accusamus
          animi, vel eum! Atque cumque quas ab quia ipsa earum asperiores
          suscipit!
        </h1>
