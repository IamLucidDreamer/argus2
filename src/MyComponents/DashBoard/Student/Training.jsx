  ...
  return (
    ...
    <h1 className="text-3xl text-center mb-8 leading-tight title-font font-bold text-white w-56 sm:w-96 mx-auto bg-red-1 rounded-b-xl px-3 pt-4 pb-5">TRAINING</h1>
      ...
      <p className="leading-relaxed text-base font-medium text-gray-2 mb-6">
        ...
        time. After completing the required time, you must take the lesson quiz
        to move on to the next module.
      </p>
      <p className="leading-relaxed text-base font-medium text-gray-2 mb-6">
        You will need to accumulate the required time for the lesson time to
        progress to the next lesson. Your time accumulation will start from the
        first slide until you reach the end of the slides or select the pause
      ...
      <p className="leading-relaxed text-base font-medium text-gray-2 mb-6">
        To schedule your First Aid Training, click on the First Aid link on the
