  ...
  return (
    ...
    >
      <div className="bg-gray-3 flex flex-row items-center rounded-t-xl">
        <img src={profile} alt="" className="w-16 h-16 m-4 border-3 rounded-xl " />
      ...
      <div className="text-gray-2 text-xl font-bold bg-gray-200 rounded-b-xl">
        <Link to="/services">
          <h1 className="rounded-lg py-5 pl-2 hover:bg-red-1 hover:text-white hover:rounded-md hover:shadow-button-inner border-b-2 border-white">
            <span className="mx-0.5 sm:mx-4 md:mx-1 lg:mx-0.5 xl:mx-4">➔</span> My Purchases
          </h1>
        </Link>
        <Link to="/services">
          <h1 className="rounded-lg py-5 pl-2 hover:bg-red-1 hover:text-white hover:rounded-md hover:shadow-button-inner border-b-2 border-white">
            <span className="mx-0.5 sm:mx-4 md:mx-1 lg:mx-0.5 xl:mx-4">➔</span> My Transcripts
          </h1>
        </Link>
        <Link to="/services">
          <h1 className="rounded-lg py-5 pl-2 hover:bg-red-1 hover:text-white hover:rounded-md hover:shadow-button-inner border-b-2 border-white">
            <span className="mx-0.5 sm:mx-4 md:mx-0.5 xl:mx-4">➔</span> Upload Documents
          </h1>
        </Link>
        <Link to="/courses">
          <h1 className="rounded-lg py-5 pl-2 hover:bg-red-1 hover:text-white hover:rounded-md hover:shadow-button-inner border-b-2 border-white">
            <span className="mx-0.5 sm:mx-4 md:mx-1 lg:mx-0.5 xl:mx-4">➔</span> Change Password
          </h1>
        </Link>
        <Link
         onClick={() => {
          ...
          <h1 className="rounded-lg py-5 pl-2 hover:bg-red-1 hover:text-white hover:rounded-md hover:shadow-button-inner border-b-2 border-white">
            <span className="mx-0.5 sm:mx-4 md:mx-1 lg:mx-0.5 xl:mx-4">➔</span> Logout
          </h1>
        </Link>
      </div>
    </div>
